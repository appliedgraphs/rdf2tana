...
const schema_builder_1 = require("../transformer/schema-builder");
...
describe('SchemaBuilder', () => {
    ...
    const parseToStore = async (turtle) => {
    ...
    `;
        ...
        const schemaBuilder = new schema_builder_1.SchemaBuilder();
    ...
    `;
        const store = await parseToStore(turtle);
        const schemaBuilder1 = new schema_builder_1.SchemaBuilder();
        const schemaBuilder2 = new schema_builder_1.SchemaBuilder();
